...
Working with results of form https://docs.google.com/spreadsheets/d/1_AZ7NCPhDMQYyw-PDBpZ7u4H5iKP_yeWovBSquvdQ4U/edit?gid=564710297#gid=564710297
...
```{r}
d <- as_tibble(read.csv('Réponses_practical2025.csv')) %>%
  rename(origin = Where.are.you.traveling.from,
